...
public interface StripsAction {
    ...
    /**
     * returns the String representation of the STRIPS Action that will be written to the text file
     * @return the String representation of the STRIPS Action that will be written to the text file
     */
    @Override
